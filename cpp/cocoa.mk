...
cocoa:
	...
	#mpirun -np 4 $(BUILD_FOLDER)Cocoa -A data/a1a.4/a1a -l 0.001 -C 100 -I 100 -f 0 -a 1 -p 0.001 -M 8
	#mpirun -np 1 $(BUILD_FOLDER)Cocoa -A data/rcvt.4/rcvt -l 0.0001 -C 100 -I 500 -f 0 -a 0 -p 0.001 -M 8
